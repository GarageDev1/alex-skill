...
dash = K.write_dashboard(wb.create_sheet(S_DASH), {
    ...
    "tracking": {
        ...
        "rows": [
            ("__band__", "一、物理锚"),
            ("云厂/AIDC capex 指引", "2026E $830B(锁定)", "关键敏感项: 运算电子收入 = capex × 强度", "四大云厂季报 capex 指引(季度)", "2027 指引 <+15% → 切 Bear 重算"),
            ("__band__", "二、AI 切片"),
            ("运算电子季度增速", "2025 +42.6% / 1Q26 未拆", "关键敏感项: 收入强度路径(0.205% vs 0.185%)", "公司季报/年报应用领域拆分(季/年)", "增速 <+15% → 强度下调一档"),
            ("XDFOI 先进封装订单", "客户认证/小批量", "关键敏感项: Bull 情景与结构溢价第二层", "公司公告/法说会(事件)", "量产大单落地 → 切 Bull; 一年无进展 → 溢价 1.15→1.05"),
            ("__band__", "三、盈利兑现"),
            ("单季净利率", "1Q26 3.2%", "关键敏感项: OPM 修复路径(Base 2026 5.0%)", "季报(季度)", "连续两季 <3.5% → 切 Bear(地板=年化 11.6亿)"),
            ("__band__", "四、估值/情绪"),
            ("P/B vs 3.91x(峰值×溢价)", "当下 4.34x(情绪 1.11)", "关键敏感项: 情绪值路径", "周度复核", "跌破 3.9x 且无基本面恶化 = 情绪正常化; 跌破 3x 带回历史区间 → 重新评估买点"),
        ],
    },
})
