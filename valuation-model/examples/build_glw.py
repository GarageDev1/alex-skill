...
K.write_consensus(wb.create_sheet(S_CONS), {
    ...
    "divergences": [
        ...
        "③ GlassBridge 市场热卖方冷: 大摩/花旗判断两年内难颠覆光模块格局, 收入已含在 Photonics $10bn 旧目标内——不是新增量, 但股价为其重复付费。",
    ],
    "stances": [
        "分析师均值(买入偏向, 目标 $206, 2026-06): AI 光通信 + 玻璃基板双引擎, 但目标价落后于现价涨幅。",
        "Morgan Stanley / Citi(GlassBridge 点评, 2026-06): 市场热、卖方冷, 两年内难颠覆光模块; GlassBridge 收入已在 $10bn Photonics 目标内。",
...
dash = K.write_dashboard(wb.create_sheet(S_DASH), {
    ...
    "blocks": [
        ...
        {"title": "C. 催化剂 — 什么会逼市场闭合 GAP", "rows": [
            ...
            ("GlassBridge/CPO 商用节奏", "2026 送样/2027 小批量/2028 量产", "卖方判断两年内难颠覆光模块; 收入已在 $10bn Photonics 目标内, 非新增量。"),
    ...
    "tracking": {
        ...
        "rows": [
            ("__band__", "一、AI 光主驱动"),
            ("Optical Enterprise 收入强度", "2025A 0.66% → 2027E 0.76%(Base)", "命门: Enterprise = capex × 强度", "季报分部 commentary", "强度回落<0.6% → 切 Bear, 重算"),
