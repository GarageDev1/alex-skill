...
def build():
    ...
    dash = K.write_dashboard(wb.create_sheet(S_DASH), {
        ...
        "tracking": {
            ...
            "rows": [
                ("__band__", "一、物理量(出货)"),
                ("全尺寸人形季度交付", "2025A 1079 台/年", "关键敏感项: 工业线收入引擎", "季报/业绩公告 + 中标公告", "连续不及 Base 路径 → 下调 ind 出货转 Bear"),
                ("消费线 U1 上量", "2026 起量", "关键敏感项: 第二增长曲线", "产品发布/交付披露", "迟迟不上量 → 下调 con 出货"),
                ("__band__", "二、价(ASP)"),
                ("工业/消费 ASP 走势", "2025A 工业 76 万", "关键敏感项: 人形收入 = 量×价", "订单单价/年报 ASP", "价格战破位 → 下调 ASP 全链重算"),
                ("__band__", "三、盈利拐点"),
                ("归母净利率", "2025A -35%", "关键敏感项: P/E 交叉验证 + 拐点", "季报/年报", "2028 未转正 → 转 Bear;2027 转正 → 上修 Bull"),
                ("__band__", "四、估值倍数/情绪"),
                ("前瞻 P/S vs 共识", "Base 11x vs 共识 9.7-22x", "关键敏感项: 目标倍数", "卖方更新 + 主题热度", "主题降温 → 情绪值下调;大单/爆发 → 上调"),
            ],
        },
    })
