...
dash = K.write_dashboard(wb.create_sheet(S_DASH), {
    ...
    "tracking": {
        ...
        "rows": [
            ("__band__", "一、核心驱动链"),
            ("AI 收入强度(HBM份额×价格)", "2025A 3.5% → 2026E 7.6%", "命门: AI收入=capex×强度", "季报分部数据+Counterpoint份额月报", "强度低于6.5% → 下调Base, 重算"),
            ("__band__", "二、商品周期"),
            ("DRAM合约价+库存周数", "Q1'26 +90% QoQ; 库存2-4周", "命门: 价格normalize时点", "TrendForce月度合约价", "连跌2季>10% → 见顶确认, 切Bear"),
            ("__band__", "三、需求总盘子"),
            ("AIDC capex指引", "2026E $830B(+70%)", "命门: 物理锚盘子", "四大云厂季报capex指引", "合计增速<20% → 2027E下调至<$950B全链重算"),
            ("__band__", "四、供给纪律"),
            ("三星capex执行率", "FY2026计划$73B(+130%)", "命门: 寡头纪律是否破坏", "三星季报+TrendForce产能跟踪", "执行>80% → normalize前移到2027H1"),
        ],
    },
})
