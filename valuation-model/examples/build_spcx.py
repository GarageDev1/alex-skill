...
dash = K.write_dashboard(wb.create_sheet(S_DASH), {
    ...
    "tracking": {
        ...
        "rows": [
            ...
            ("AI1 散热实测", "待", "命门: 轨道算力期权(逐年 $0→$200B)与 AI 营收", "AI1 卫星在轨数据 / 公司披露", "达标 → 上调 Bull 概率 + AI 营收/倍数"),
            ("AI 经营利润", "亏损", "命门: AI 2027 转正假设", "季报分部附注", "转正 → 验证 Base; 持续亏 → 转 Bear"),
            ("__band__", "二、Starlink 现金牛"),
            ("blended ARPU", "$143 下行", "命门: Starlink 逐年营收/EV/Sales", "季度 KPI 表", "跌破 $50 → 下调 Starlink; 企稳 $60 → 维持"),
            ("__band__", "三、发射 / Starship"),
            ("Starship Flight", "V3 刚炸", "命门: 发射逐年营收 + $100/kg 期权", "SpaceX 发射记录 / FAA", "Flight 13+ 成功 → 上调; 再炸 → 下调"),
        ],
    },
})
