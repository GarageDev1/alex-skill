...
```json
{
  ...
  "subtitle": "覆盖产能结构与扩产进度，明年你换手机和加内存大概率要多掏钱",
...
- 好：`覆盖产能结构与扩产进度，明年你换手机和加内存大概率要多掏钱`
...
- **破折号**：禁止使用"——"连接前后半句，用逗号。
- **元话语套话**：标题、副标题和卡片禁止"这场竞赛""这个行业""一图看清""一文读懂""全景梳理""深度解析"等不承载信息的指代词和包装语。检验标准：删掉这个词后句子信息量零损失的，就是废话，必须删。
  - 好："从定制芯片、算力资本到电力瓶颈，你的AI会员费可能要涨价了"
  - 坏："这场竞赛决定你的AI会员费走向"（"这场竞赛"是空转指代，删掉信息零损失）
- **二元模糊结论**：禁止"是涨是跌""是X还是Y"式正反并列收尾。传导链终点必须给方向性判断（"可能涨""大概率降价"），且该判断要在正文卡片中有依据。
  - 好："你的AI会员费可能要涨价了"
  - 坏："你的AI会员费是涨是跌"（正反并列等于没说）
